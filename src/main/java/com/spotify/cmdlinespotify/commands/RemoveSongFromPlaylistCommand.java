...
public class RemoveSongFromPlaylistCommand implements Command{
    ...
    public boolean matches(String input) {
        ...
        if(inputWords.size() == 3 && inputWords.get(0).equalsIgnoreCase(CommandKeywords.removeSongFromPlaylist))
        {
            return true;
        }
        return false;
    ...
    public void excecute(String input) {
        ...
        ResponseDTO responseDTO = playlistController.removeSongFromPlaylist(songToPlaylistRequestDTO);
